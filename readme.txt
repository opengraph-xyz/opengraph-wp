...
* Update WordPress compatibility metadata through version 7.1

= 1.5.6 =
* Remove the filters JavaScript dependency

= 1.5.5 =
* Enhance Open Graph tag handling for better compatibility with multiple SEO plugins
